...
export function factoryTag(
  ...
  function attributePrimaryName(code) {
    ...
    if (code === 45 || (code !== null && idContAttr(code))) {
      effects.consume(code)
      return attributePrimaryName
  ...
  function isAfterWhitespace() {
    return (
      ...
      unicodeWhitespace(self.previous)
    )
  }
  /**
  ...
  function idStartAttr(code) {
    return (
      ((code === 58 || code === 64) && isAfterWhitespace()) || idStart(code)
    )
  }
  /**
